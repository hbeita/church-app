...
class Church::PrayPetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create church_pray_petition" do
    assert_difference('Church::PrayPetition.count') do
      post church_pray_petitions_url, params: { church_pray_petition: { pray_for: @church_pray_petition.pray_for, request_from: @church_pray_petition.request_from } }
    end
  ...
  test "should update church_pray_petition" do
    patch church_pray_petition_url(@church_pray_petition), params: { church_pray_petition: { pray_for: @church_pray_petition.pray_for, request_from: @church_pray_petition.request_from } }
